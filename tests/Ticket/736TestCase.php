...
class Doctrine_Ticket_736_TestCase extends Doctrine_UnitTestCase
{
	...
	$this->assertTrue($module->moduledata->content == "foo");
    }
}
...
class T736_ModuleLoaderListener extends Doctrine_Record_Listener
{
    ...
    {
        $contents = $event->data;
        $delegate = Doctrine_Manager::getInstance()->getTable("T736_ModuleDelegate")->find($contents["moduledelegateid"], ($contents instanceof Doctrine_Record) ? Doctrine::HYDRATE_RECORD :Doctrine::HYDRATE_ARRAY );
